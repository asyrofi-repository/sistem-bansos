    ...
    <div class="container-fluid">
        <div class="row box-info p-3">
            <div class="col">
                ...
                <form method="POST" action="services/update_bantuan.php?id=<?php echo $id ?>">
                    <div class="form-group">
                        <label for="asal_bantuan">Asal Bantuan</label>
                        <input type="text" class="form-control" id="asal_bantuan" name="asal_bantuan" placeholder="Pemerintah Provinsi Jawa Barat" value="<?php echo $result['asal_bantuan'] ?>" required>
                    </div>
                    <div class="form-group ">
                        <label for="deskripsi">Deskripsi</label>
                        <textarea class="form-control" name="deskripsi" id="deskripsi" cols="30" rows="3" placeholder="Bantuan sembako berupa uang tunai" required><?php echo $result['deskripsi'] ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="tanggal_terima">Tanggal Penerimaan</label>
                        <input type="date" class="form-control" id="tanggal_terima" name="tanggal_terima" value="<?php echo $result['tanggal_terima'] ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="jumlah_penerima">Jumlah Penerima</label>
                        <input type="number" class="form-control " id="jumlah_penerima" name="jumlah_penerima" placeholder="25" value="<?php echo $result['jumlah_terima'] ?>" required <?php if($result['set_penerima'] == 1){echo "disabled";} ?>>
                    </div>
